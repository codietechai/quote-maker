...
import { QuoteForm } from "@/components/screens/travel/quote-form";
    ...
    <>
      ...
      <div className="bg-blue-50">
        <div className="max-w-4xl mx-auto px-4 py-10">
          <PageHeader
            heading="Travel Quote"
            description="Get personalized travel insurance quotes to enjoy your trip with peace of mind."
          />
          <div className="mt-10">
            <QuoteForm />
          </div>
